...
/**
* @brief  Re-Initialize th device library
* @param  pdev: device instance
...
/**
  * @brief  Start the USB Device Core.
...
/**
  * @brief  Stop the USB Device Core.
  * @param  pdev: Device Handle
  * @retval USBD Status
  */
...
*/
USBD_StatusTypeDef USBD_ClearClassConfig(USBD_HandleTypeDef  *pdev, uint8_t cfgidx)
{
